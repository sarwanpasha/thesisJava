...
//    static int[] a2_new = new int[Node_Count];
    ...
    public static void Decile_Bin_Function() throws IOException{
         System.err.println("Welcome!! Decile Bin Logic");
        int outerLoop;
        int innerLoop;
...
//                attribute2 = 1; // Gender
                ...
                String   writeFileName1 = 
                		"C:\\Users\\Pasha\\Desktop\\errors\\caltech\\Decile\\";
...
//                    System.err.println("Contingency Table = " + Contingency);
     ...
     public static void read_Column_Of_File(String filename){
        ...
        try{
            ...
            int row_Counter=0;
            double[][] File_Values = new double[Hidden_Count][2];
...
//                System.err.println("splitStr[1] = " +  splitStr[1]);
                row_Counter++;
    ...
    public static double findSmallest_Other_Then_Zero(double[] arr) {
    ...
    public static int[] Normalized_Probabilities(double[] temp_Prediction_2_temp){
        ...
        double[] temp_Prediction_2 = new double[temp_Prediction_2_temp.length];
         ...
         for(int m=1; m<temp_Prediction_2_temp.length; m++){
             temp_Prediction_2_Normalized[m-1] = temp_Prediction_2_temp[m];
            System.err.println("temp_Prediction_2_temp = " + temp_Prediction_2_Normalized[m-1]);
        }
         
//        temp_Prediction_2 = removeElements(temp_Prediction_2_temp,0);
        temp_Prediction_2 = temp_Prediction_2_Normalized;
...
//            Arrays.sort(temp_Prediction_2);
            Smallest_Value = findSmallest_Other_Then_Zero(temp_Prediction_2);
            temp_Normalized = Smallest_Value;
//            temp_Normalized = temp_Prediction_2[0];
            System.err.println("Smallest = " + Smallest_Value);
...
//            System.err.println("temp_Normalized = " + temp_Normalized);
            //if(temp_Normalized<1 && temp_Normalized!=0){
                while(Smallest_Value<1 && Smallest_Value>0){
                        temp_Normalized = Smallest_Value;
...
//                        Smallest_Value = temp_Normalized;
