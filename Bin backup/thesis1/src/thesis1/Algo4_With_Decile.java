 ...
 * @author Pasha
 */
public class Algo4_With_Decile {
...
//    static int[] Hidden_Users = {3};
    ...
    static int Decile_1 = 10;
    static int Decile_2 = 20;
    static int Decile_3 = 30;
    static int Decile_4 = 40;
    static int Decile_5 = 50;
    static int Decile_6 = 60;
    static int Decile_7 = 70;
    static int Decile_8 = 80;
    static int Decile_9 = 90;
    static int Decile_10 = 100;
...
//                }
                ...
                int NAN_Count=0;
                int [] Friends_Bin_Array = new int[10];
...
//                                + " Are = " + Immediate_friends.size());
                    ...
                    Friends_Bin_Array[4] = 0;
                    Friends_Bin_Array[5] = 0;
                    Friends_Bin_Array[6] = 0;
                    Friends_Bin_Array[7] = 0;
                    Friends_Bin_Array[8] = 0;
                    Friends_Bin_Array[9] = 0;
...
//                            System.err.println("Lookup value = " + quartile_lookup);
                            if (h != 0) {
                                if (quartile_lookup >= 0 && quartile_lookup <= Decile_1) {
                                    Friends_Bin_Array[0]++;
                                } else if (quartile_lookup > Decile_1 && quartile_lookup <= Decile_2) {
                                    Friends_Bin_Array[1]++;
                                } else if (quartile_lookup > Decile_2 && quartile_lookup <= Decile_3) {
                                    Friends_Bin_Array[2]++;
                                } else if (quartile_lookup > Decile_3 && quartile_lookup <= Decile_4) {
                                    Friends_Bin_Array[3]++;
                                } else if (quartile_lookup > Decile_4 && quartile_lookup <= Decile_5) {
                                    Friends_Bin_Array[4]++;
                                } else if (quartile_lookup > Decile_5 && quartile_lookup <= Decile_6) {
                                    Friends_Bin_Array[5]++;
                                } else if (quartile_lookup > Decile_6 && quartile_lookup <= Decile_7) {
                                    Friends_Bin_Array[6]++;
                                } else if (quartile_lookup > Decile_7 && quartile_lookup <= Decile_8) {
                                    Friends_Bin_Array[7]++;
                                } else if (quartile_lookup > Decile_8 && quartile_lookup <= Decile_9) {
                                    Friends_Bin_Array[8]++;
                                } else if (quartile_lookup > Decile_9 && quartile_lookup <= Decile_10) {
                                    Friends_Bin_Array[9]++;
                                } 
                                else {
...
//                    System.out.println("Unique Bin Values " + i + " = " + Unique_Bin__Distribution_Values[i]);
                }
