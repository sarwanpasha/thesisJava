 ...
 * @author Pasha
 */
public class Algo4_With_20_Bins {
...
//    static int[] Hidden_Users = { 7, 9, 11, 13, 684,704, 712, 725,  743,  751};
    ...
    static int Bin_8 = 40;
    static int Bin_9 = 45;
    static int Bin_10 = 50;
    static int Bin_11 = 55;
    static int Bin_12 = 60;
    static int Bin_13 = 65;
    static int Bin_14 = 70;
    static int Bin_15 = 75;
    static int Bin_16 = 80;
    static int Bin_17 = 85;
    static int Bin_18 = 90;
    static int Bin_19 = 95;
    static int Bin_20 = 100;
        ...
        for (outerLoop = 0; outerLoop < attributeCount; outerLoop++) {
            for (innerLoop = 0; innerLoop < attributeCount; innerLoop++) {
                ...
                String   writeFileName1 = 
                		"E:/MS Computer Science/MS Thesis/Java Code/errorResults/Rice/20Bins/";
...
//                                    Friends_Bin_Array[3]++;
                                }else if (quartile_lookup > Bin_10 && quartile_lookup <= Bin_11) {
                                    Friends_Bin_Array_Counter=11;
//                                    Friends_Bin_Array[3]++;
                                }else if (quartile_lookup > Bin_11 && quartile_lookup <= Bin_12) {
                                    Friends_Bin_Array_Counter=12;
//                                    Friends_Bin_Array[3]++;
                                }else if (quartile_lookup > Bin_12 && quartile_lookup <= Bin_13) {
                                    Friends_Bin_Array_Counter=13;
//                                    Friends_Bin_Array[3]++;
                                }else if (quartile_lookup > Bin_13 && quartile_lookup <= Bin_14) {
                                    Friends_Bin_Array_Counter=14;
//                                    Friends_Bin_Array[3]++;
                                }else if (quartile_lookup > Bin_14 && quartile_lookup <= Bin_15) {
                                    Friends_Bin_Array_Counter=15;
//                                    Friends_Bin_Array[3]++;
                                }else if (quartile_lookup > Bin_15 && quartile_lookup <= Bin_16) {
                                    Friends_Bin_Array_Counter=16;
//                                    Friends_Bin_Array[3]++;
                                }else if (quartile_lookup > Bin_16 && quartile_lookup <= Bin_17) {
                                    Friends_Bin_Array_Counter=17;
//                                    Friends_Bin_Array[3]++;
                                }else if (quartile_lookup > Bin_17 && quartile_lookup <= Bin_18) {
                                    Friends_Bin_Array_Counter=18;
//                                    Friends_Bin_Array[3]++;
                                }else if (quartile_lookup > Bin_18 && quartile_lookup <= Bin_19) {
                                    Friends_Bin_Array_Counter=19;
//                                    Friends_Bin_Array[3]++;
                                }else if (quartile_lookup > Bin_19 && quartile_lookup <= Bin_20) {
                                    Friends_Bin_Array_Counter=20;
//                                    Friends_Bin_Array[3]++;
...
//                            }
                            Final_predicted_Value[j] = Weighted_Sampe(temp_Prediction_3);
                            /////////////////////////////////////////////////////////
