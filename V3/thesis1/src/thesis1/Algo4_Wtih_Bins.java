...
//    static int[] Hidden_Users_range = IntStream.rangeClosed(1, 769).toArray();
    ...
    static int[] Major_Attribute_Bin_0={0};
    static int[] Major_Attribute_Bin_1 = IntStream.rangeClosed(180,210).toArray();
    static int[] Major_Attribute_Bin_2 = IntStream.rangeClosed(211,240).toArray();
    static int[] Actual_Major_Attribute_Bin_Array = new int[3];
    static int[] Predicted_Major_Attribute_Bin_Array = new int[3];
    
    static int[] Minor_Attribute_Bin_0 = {0};
    static int[] Minor_Attribute_Bin_1 = IntStream.rangeClosed(180,215).toArray();
    static int[] Minor_Attribute_Bin_2 = IntStream.rangeClosed(216,245).toArray();
    static int[] Actual_Minor_Attribute_Bin_Array = new int[3];
    static int[] Predicted_Minor_Attribute_Bin_Array = new int[3];
    
    static int[] Dorm_Attribute_Bin_0 = {0};
    static int[] Dorm_Attribute_Bin_1 = IntStream.rangeClosed(160,168).toArray();
    static int[] Dorm_Attribute_Bin_2 = IntStream.rangeClosed(169,175).toArray();
    static int[] Actual_Dorm_Attribute_Bin_Array = new int[3];
    static int[] Predicted_Dorm_Attribute_Bin_Array = new int[3];
    
    static int[] Graduation_Year_Attribute_Bin_0 = {0};
    static int[] Graduation_Year_Attribute_Bin_1 = IntStream.rangeClosed(1960,2000).toArray();
    static int[] Graduation_Year_Attribute_Bin_2 = IntStream.rangeClosed(2001,2010).toArray();
    static int[] Actual_Graduation_Year_Attribute_Bin_Array = new int[3];
    static int[] Predicted_Graduation_Year_Attribute_Bin_Array = new int[3];
    
    static int[] High_School_Year_Attribute_Bin_0 = {0};
    static int[] High_School_Year_Attribute_Bin_1 = IntStream.rangeClosed(240,10000).toArray();
    static int[] High_School_Year_Attribute_Bin_2 = IntStream.rangeClosed(10001,20000).toArray();
    static int[] High_School_Year_Attribute_Bin_3 = IntStream.rangeClosed(20001,57100).toArray();
    static int[] Actual_High_School_Year_Attribute_Bin_Array = new int[4];
    static int[] Predicted_High_School_Year_Attribute_Bin_Array = new int[4];

    static int count_Actual_Zeros = 0;
...
//                }
                ...
                int[] max_Degree_Array = new int[Hidden_Count];
...
//                        System.err.println("Hidden User = " + a2[Hidden_Users[i]-1]);
                        ...
                        Collections.sort(Immediate_friends);
//                        System.err.println(" AND Total Immediate Friends of User = " + i + " Are = " + Immediate_friends);
                        Immediate_Friends_distribution = computing_attribute_Value(Immediate_friends, a2_distinct);
                        max_Degree_Array[i] = Arrays.stream(Immediate_Friends_distribution).max().getAsInt();
//                        System.out.println("Max friend degree = " + max);
                        ...
                        System.err.println("Immediate_Friends_distribution of Node" + 
                                (Hidden_Users[i]-1)+ " are = " + temp_imm_Friends);
                        int[] Immediate_Friends_distribution_row_sum=new int[Immediate_friends.size()];
                        for(int y=0; y<Immediate_friends.size(); y++){
                        for (int h = 0; h < a2_distinct.length; h++) {
//                                System.err.println("finding_Max_Vote_class for friend " + j + " = " + Friends_of_friend.size() + " AND Total Gender of friend = "
//                                        + FOF_distribution[h]);
                                if (h != 0) {
                                    Immediate_Friends_distribution_row_sum[y] = Immediate_Friends_distribution_row_sum[y] 
                                            + Immediate_Friends_distribution[h];
                                }
                        ...
                        for(int y=0; y<Immediate_friends.size(); y++){
                            for (int h = 0; h < a2_distinct.length; h++) {
                                if (h != 0) {
                                    if(Immediate_Friends_distribution_row_sum[y]!=0){
//                                    System.err.println("FOF_distribution_normalized = " + FOF_distribution[h]);
                                    Immediate_Friends_distribution_normalized[h] = 
                                            ((double)Immediate_Friends_distribution[h]/ Immediate_Friends_distribution_row_sum[y]) * 100;
                                }
                                    else{
                                         Immediate_Friends_distribution_normalized[h]=0;
                                    }
                                }
//                                System.err.println("finding_Max_Vote_class = " + FOF_distribution_normalized[h]);
                            }
                        }
                        String temp_imm_Friends_Distribution = "";
                        for(int h=0; h<Immediate_Friends_distribution.length; h++){
                            temp_imm_Friends_Distribution = temp_imm_Friends_Distribution + 
                                    Immediate_Friends_distribution_normalized[h] + " ";
                        }
//                         System.err.println("Immediate_Friends_distribution of Node" + i+ " are = " + 
//                                 temp_imm_Friends_Distribution);   
//                            System.err.println(temp_imm_Friends_Distribution); 
...
//                                    Immediate_friends.get(j) + " Are = " + Friends_of_friend);
                            ...
                            FOF_distribution = computing_attribute_Value(Friends_of_friend, a2_distinct); //finding_Max_Vote_class
...
//                        System.err.println("Mode " + i + " is = " + a2_distinct[(int)Final_predicted_Value[i]]);
...
//                    System.err.println("Actual value = " + Actual_Value[i]);
                    
                    //Binning of actual values
                    
                    boolean Major_Actual_result_0 = contains(Major_Attribute_Bin_0,Actual_Value[i]);
                    boolean Major_Actual_result_1 = contains(Major_Attribute_Bin_1,Actual_Value[i]);
                    boolean Major_Actual_result_2 = contains(Major_Attribute_Bin_2,Actual_Value[i]);
                    
                    boolean Major_Predicted_result_0 = 
                            contains(Major_Attribute_Bin_0,a2_distinct[(int)Final_predicted_Value[i]]);
                    boolean Major_Predicted_result_1 = 
                            contains(Major_Attribute_Bin_1,a2_distinct[(int)Final_predicted_Value[i]]);
                    boolean Major_Predicted_result_2 = 
                            contains(Major_Attribute_Bin_2,a2_distinct[(int)Final_predicted_Value[i]]);
                    
                    if(temp_attr_2.equals("major")){
                        //Check for Actual values
                        if(Major_Actual_result_0){
                            Actual_Major_Attribute_Bin_Array[0] ++;
                        } 
                        else if(Major_Actual_result_1){
                            Actual_Major_Attribute_Bin_Array[1] ++;
                        }
                        else if(Major_Actual_result_2){
                            Actual_Major_Attribute_Bin_Array[2] ++;
                        }
                        else{
                            System.err.println("Actual value = " + Actual_Value[i]);
                        }
                        //Check for predicted values
                        if(Major_Predicted_result_0){
                            Predicted_Major_Attribute_Bin_Array[0] ++;
                        } 
                        else if(Major_Predicted_result_1){
                            Predicted_Major_Attribute_Bin_Array[1] ++;
                        }
                        else if(Major_Predicted_result_2){
                            Predicted_Major_Attribute_Bin_Array[2] ++;
                        }
                        else{
                            System.err.println("Predicted value = " + a2_distinct[(int)Final_predicted_Value[i]]);
                        }
                    }
                        
                    boolean Minor_Actual_result_0 = contains(Minor_Attribute_Bin_0,Actual_Value[i]);
                    boolean Minor_Actual_result_1 = contains(Minor_Attribute_Bin_1,Actual_Value[i]);
                    boolean Minor_Actual_result_2 = contains(Minor_Attribute_Bin_2,Actual_Value[i]);
                    
                    boolean Minor_Predicted_result_0 = 
                            contains(Minor_Attribute_Bin_0,a2_distinct[(int)Final_predicted_Value[i]]);
                    boolean Minor_Predicted_result_1 = 
                            contains(Minor_Attribute_Bin_1,a2_distinct[(int)Final_predicted_Value[i]]);
                    boolean Minor_Predicted_result_2 = 
                            contains(Minor_Attribute_Bin_2,a2_distinct[(int)Final_predicted_Value[i]]);
                    
                    if(temp_attr_2.equals("minor")){
                        //Check for Actual values
                        if(Minor_Actual_result_0){
                            Actual_Minor_Attribute_Bin_Array[0] ++;
                        } 
                        else if(Minor_Actual_result_1){
                            Actual_Minor_Attribute_Bin_Array[1] ++;
                        }
                        else if(Minor_Actual_result_2){
                            Actual_Minor_Attribute_Bin_Array[2] ++;
                        }
                        else{
                            System.err.println("Actual value = " + Actual_Value[i]);
                        }
                        //Check for predicted values
                        if(Minor_Predicted_result_0){
                            Predicted_Minor_Attribute_Bin_Array[0] ++;
                        } 
                        else if(Minor_Predicted_result_1){
                            Predicted_Minor_Attribute_Bin_Array[1] ++;
                        }
                        else if(Minor_Predicted_result_2){
                            Predicted_Minor_Attribute_Bin_Array[2] ++;
                        }
                        else{
                            System.err.println("Predicted value = " + a2_distinct[(int)Final_predicted_Value[i]]);
                        }
                    ...
                    boolean Dorm_Actual_result_0 = contains(Dorm_Attribute_Bin_0,Actual_Value[i]);
                    boolean Dorm_Actual_result_1 = contains(Dorm_Attribute_Bin_1,Actual_Value[i]);
                    boolean Dorm_Actual_result_2 = contains(Dorm_Attribute_Bin_2,Actual_Value[i]);
                    
                    boolean Dorm_Predicted_result_0 = 
                            contains(Dorm_Attribute_Bin_0,a2_distinct[(int)Final_predicted_Value[i]]);
                    boolean Dorm_Predicted_result_1 = 
                            contains(Dorm_Attribute_Bin_1,a2_distinct[(int)Final_predicted_Value[i]]);
                    boolean Dorm_Predicted_result_2 = 
                            contains(Dorm_Attribute_Bin_2,a2_distinct[(int)Final_predicted_Value[i]]);
                    
                    
                    if(temp_attr_2.equals("dorm")){
                        //Check for Actual values
                        if(Dorm_Actual_result_0){
                            Actual_Dorm_Attribute_Bin_Array[0] ++;
                        } 
                        else if(Dorm_Actual_result_1){
                            Actual_Dorm_Attribute_Bin_Array[1] ++;
                        }
                        else if(Dorm_Actual_result_2){
                            Actual_Dorm_Attribute_Bin_Array[2] ++;
                        }
                        else{
                            System.err.println("Actual value = " + Actual_Value[i]);
                        }
                        //Check for predicted values
                        if(Dorm_Predicted_result_0){
                            Predicted_Dorm_Attribute_Bin_Array[0] ++;
                        } 
                        else if(Dorm_Predicted_result_1){
                            Predicted_Dorm_Attribute_Bin_Array[1] ++;
                        }
                        else if(Dorm_Predicted_result_2){
                            Predicted_Dorm_Attribute_Bin_Array[2] ++;
                        }
                        else{
                            System.err.println("Predicted value = " + a2_distinct[(int)Final_predicted_Value[i]]);
                        }
                    ...
                    boolean Graduation_Year_Actual_result_0 = contains(Graduation_Year_Attribute_Bin_0,Actual_Value[i]);
                    boolean Graduation_Year_Actual_result_1 = contains(Graduation_Year_Attribute_Bin_1,Actual_Value[i]);
                    boolean Graduation_Year_Actual_result_2 = contains(Graduation_Year_Attribute_Bin_2,Actual_Value[i]);
                    
                    boolean Graduation_Year_Predicted_result_0 = 
                            contains(Graduation_Year_Attribute_Bin_0,a2_distinct[(int)Final_predicted_Value[i]]);
                    boolean Graduation_Year_Predicted_result_1 = 
                            contains(Graduation_Year_Attribute_Bin_1,a2_distinct[(int)Final_predicted_Value[i]]);
                    boolean Graduation_Year_Predicted_result_2 = 
                            contains(Graduation_Year_Attribute_Bin_2,a2_distinct[(int)Final_predicted_Value[i]]);
                    
                    if(temp_attr_2.equals("Graduation_Year")){
                        //Check for Actual values
                        if(Graduation_Year_Actual_result_0){
                            Actual_Graduation_Year_Attribute_Bin_Array[0] ++;
                        } 
                        else if(Graduation_Year_Actual_result_1){
                            Actual_Graduation_Year_Attribute_Bin_Array[1] ++;
                        }
                        else if(Graduation_Year_Actual_result_2){
                            Actual_Graduation_Year_Attribute_Bin_Array[2] ++;
                        }
                        else{
                            System.err.println("Actual value = " + Actual_Value[i]);
                        }
                        //Check for predicted values
                        if(Graduation_Year_Predicted_result_0){
                            Predicted_Graduation_Year_Attribute_Bin_Array[0] ++;
                        } 
                        else if(Graduation_Year_Predicted_result_1){
                            Predicted_Graduation_Year_Attribute_Bin_Array[1] ++;
                        }
                        else if(Graduation_Year_Predicted_result_2){
                            Predicted_Graduation_Year_Attribute_Bin_Array[2] ++;
                        }
                        else{
                            System.err.println("Predicted value = " + a2_distinct[(int)Final_predicted_Value[i]]);
                        }
                    ...
                    boolean High_School_Actual_result_0 = contains(High_School_Year_Attribute_Bin_0,Actual_Value[i]);
                    boolean High_School_Actual_result_1 = contains(High_School_Year_Attribute_Bin_1,Actual_Value[i]);
                    boolean High_School_Actual_result_2 = contains(High_School_Year_Attribute_Bin_2,Actual_Value[i]);
                    boolean High_School_Actual_result_3 = contains(High_School_Year_Attribute_Bin_3,Actual_Value[i]);
                    
                    boolean High_School_Predicted_result_0 = 
                            contains(High_School_Year_Attribute_Bin_0,a2_distinct[(int)Final_predicted_Value[i]]);
                    boolean High_School_Predicted_result_1 = 
                            contains(High_School_Year_Attribute_Bin_1,a2_distinct[(int)Final_predicted_Value[i]]);
                    boolean High_School_Predicted_result_2 = 
                            contains(High_School_Year_Attribute_Bin_2,a2_distinct[(int)Final_predicted_Value[i]]);
                    boolean High_School_Predicted_result_3 = 
                            contains(High_School_Year_Attribute_Bin_3,a2_distinct[(int)Final_predicted_Value[i]]);
                    
                    if(temp_attr_2.equals("high_school")){
                        //Check for Actual values
                        if(High_School_Actual_result_0){
                            Actual_High_School_Year_Attribute_Bin_Array[0] ++;
                        } 
                        else if(High_School_Actual_result_1){
                            Actual_High_School_Year_Attribute_Bin_Array[1] ++;
                        }
                        else if(High_School_Actual_result_2){
                            Actual_High_School_Year_Attribute_Bin_Array[2] ++;
                        }
                        else if(High_School_Actual_result_3){
                            Actual_High_School_Year_Attribute_Bin_Array[3] ++;
                        }
                        else{
                            System.err.println("Actual value = " + Actual_Value[i]);
                        }
                        //Check for predicted values
                        if(High_School_Predicted_result_0){
                            Predicted_High_School_Year_Attribute_Bin_Array[0] ++;
                        } 
                        else if(High_School_Predicted_result_1){
                            Predicted_High_School_Year_Attribute_Bin_Array[1] ++;
                        }
                        else if(High_School_Predicted_result_2){
                            Predicted_High_School_Year_Attribute_Bin_Array[2] ++;
                        }
                        else if(High_School_Predicted_result_3){
                            Predicted_High_School_Year_Attribute_Bin_Array[3] ++;
                        }
                        else{
                            System.err.println("Predicted value = " + a2_distinct[(int)Final_predicted_Value[i]]);
                        }
                ...
                int max = Arrays.stream(max_Degree_Array).max().getAsInt();
                        System.out.println("Max friend degree = " + max);
                        
                System.out.println("Total Zeros = " + count_Actual_Zeros);
                
                if(temp_attr_2.equals("major")){
                String temp_Actual_major="";
                String temp_Predicted_major="";
                for(int i=0; i<Actual_Major_Attribute_Bin_Array.length; i++){
                    temp_Actual_major = temp_Actual_major + Actual_Major_Attribute_Bin_Array[i] + " ";
                    temp_Predicted_major = temp_Predicted_major + Predicted_Major_Attribute_Bin_Array[i] + " ";
                }
                System.out.println("Actual Major array value = " + temp_Actual_major);
                System.out.println("Predicted Major array value = " + temp_Predicted_major);
                }
                
                if(temp_attr_2.equals("minor")){
                String temp_Actual_minor="";
                String temp_Predicted_minor="";
                for(int i=0; i<Actual_Minor_Attribute_Bin_Array.length; i++){
                    temp_Actual_minor = temp_Actual_minor + Actual_Minor_Attribute_Bin_Array[i] + " ";
                    temp_Predicted_minor = temp_Predicted_minor + Predicted_Minor_Attribute_Bin_Array[i] + " ";
                }
                System.out.println("Actual Minor array value = " + temp_Actual_minor);
                System.out.println("Predicted Minor array value = " + temp_Predicted_minor);
                }
                
                if(temp_attr_2.equals("dorm")){
                String temp_Actual_Dorm="";
                String temp_Predicted_Dorm="";
                for(int i=0; i<Actual_Dorm_Attribute_Bin_Array.length; i++){
                    temp_Actual_Dorm = temp_Actual_Dorm + Actual_Dorm_Attribute_Bin_Array[i] + " ";
                    temp_Predicted_Dorm = temp_Predicted_Dorm + Predicted_Dorm_Attribute_Bin_Array[i] + " ";
                }
                System.out.println("Actual Dorm array value = " + temp_Actual_Dorm);
                System.out.println("Predicted Dorm array value = " + temp_Predicted_Dorm);
                }
                
                if(temp_attr_2.equals("Graduation_Year")){
                String temp_Actual_Graduation_Year="";
                String temp_Predicted_Graduation_Year="";
                for(int i=0; i<Actual_Graduation_Year_Attribute_Bin_Array.length; i++){
                    temp_Actual_Graduation_Year = temp_Actual_Graduation_Year + 
                            Actual_Graduation_Year_Attribute_Bin_Array[i] + " ";
                    temp_Predicted_Graduation_Year = temp_Predicted_Graduation_Year + 
                            Predicted_Graduation_Year_Attribute_Bin_Array[i] + " ";
                }
                System.out.println("Actual Graduation_Year array value = " + temp_Actual_Graduation_Year);
                System.out.println("Predicted Graduation_Year array value = " + temp_Predicted_Graduation_Year);
                }
                
                if(temp_attr_2.equals("high_school")){
                String temp_Actual_high_school="";
                String temp_Predicted_high_school="";
                for(int i=0; i<Actual_High_School_Year_Attribute_Bin_Array.length; i++){
                    temp_Actual_high_school = temp_Actual_high_school + 
                            Actual_High_School_Year_Attribute_Bin_Array[i] + " ";
                    temp_Predicted_high_school = temp_Predicted_high_school + 
                            Predicted_High_School_Year_Attribute_Bin_Array[i] + " ";
                }
                System.out.println("Actual high_school array value = " + temp_Actual_high_school);
                System.out.println("Predicted high_school array value = " + temp_Predicted_high_school);
                }
...
//                }
                ...
                for(int i=0; i<Hidden_Count; i++){
                    ...
                    row_index = indexOf(a2_distinct[(int)Final_predicted_Value[i]], a2_distinct);
...
//                    System.err.println("Predicted Value = " + (int)Final_predicted_Value[i]);
                    if(a2_distinct[(int)Final_predicted_Value[i]] == a2[Hidden_Users[i]-1]){
                        success++;
                    }
                    else{
                        failure++;
