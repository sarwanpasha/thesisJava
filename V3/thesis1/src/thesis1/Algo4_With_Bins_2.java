        ...
        for (outerLoop = 0; outerLoop < attributeCount; outerLoop++) {
            for (innerLoop = 0; innerLoop < attributeCount; innerLoop++) {
                ...
                String   writeFileName1 = 
                		"E:/MS Computer Science/MS Thesis/Java Code/errorResults/Rice/QuartileBins/";
...
//                                            (double) sum_Of_type_occurence[j] + " = " + Type_Wise_a2_Attribute_Normalized[y] + " ";
                                    ...
                                    Error_myList.add(Type_Wise_a2_Attribute_Normalized[y]);
...
//                            }
//                           File writting Ends Here !!!! 
//                            System.out.println("Error = " + Absolute_Error_Array[i]);
